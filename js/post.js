    ...
    createPostElement() {
        ...
        postDiv.html(`
            <div class="post-user-information">
                <img src="img/circletest.png" class="user-icon-post">
...
function displayPosts(posts) {
    ...
    posts.forEach(function (i) {
        post = new Post(i.post_id, i.title, i.content, i.img1, i.img2, i.img3, i.img4, i.postdate, i.likes , i.userid, i.username, i.profile_image, i.categoryid, i.tagid);
